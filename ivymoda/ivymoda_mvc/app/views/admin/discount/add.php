<?php
// filepath: C:\xampp\htdocs\ivymoda\ivymoda_mvc\app\views\admin\discount\add.php
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <form method="POST" action="<?= ADMIN_URL ?>discount/add">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ma_code" name="ma_code" 
                                           value="<?= htmlspecialchars($_POST['ma_code'] ?? '') ?>" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ma_ten" name="ma_ten" 
                                           value="<?= htmlspecialchars($_POST['ma_ten'] ?? '') ?>" 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="loai_giam" name="loai_giam" required>
                                        <option value="percent" <?= ($_POST['loai_giam'] ?? 'percent') === 'percent' ? 'selected' : '' ?>>
                                            Phần trăm (%)
                                        </option>
                                        <option value="fixed" <?= ($_POST['loai_giam'] ?? '') === 'fixed' ? 'selected' : '' ?>>
                                            Số tiền cố định (₫)
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="ma_giam" name="ma_giam" 
                                           value="<?= htmlspecialchars($_POST['ma_giam'] ?? '') ?>" 
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="trang_thai" name="trang_thai" 
                                       <?= isset($_POST['trang_thai']) ? 'checked' : '' ?>>
