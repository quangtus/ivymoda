        ...
        <ul>
            ...
            <li><a href="#">Sản phẩm</a>
                <ul>
                    ...
                    <li><a href="<?php echo BASE_URL; ?>admin/product-image">Quản lý ảnh</a></li>
                </ul>
            </li>
            
            <!-- Danh mục & Phân loại -->
            <li><a href="#">Danh mục & Phân loại</a>
                <ul>
                    <li><a href="<?php echo ADMIN_URL; ?>category">Danh mục chính</a></li>
            ...
            <li><a href="#">Khuyến mãi</a>
                <ul>
                    ...
                    <li><a href="<?php echo BASE_URL; ?>admin/promotion">Banner khuyến mãi</a></li>
            ...
            <li><a href="#">Quản lý Email</a>
                <ul>
                    ...
                    <li><a href="<?= BASE_URL ?>admin/email/smtp-config">Cấu hình SMTP</a></li>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <?php if(isset($_SESSION['role_id']) && $_SESSION['role_id'] == 1): ?>
            <li class="has-sub">
                <a href="<?php echo BASE_URL; ?>admin/user">Tài khoản</a>
                <ul class="submenu">
