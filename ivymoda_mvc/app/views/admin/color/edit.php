    ...
    <div class="admin-content-right-main">
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Sửa màu sắc</h1>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="color_ten" name="color_ten" 
                                   value="<?= htmlspecialchars($color->color_ten) ?>" 
                                   placeholder="Ví dụ: Đen, Trắng, Đỏ" required>
                        </div>
                        <div class="form-group">
